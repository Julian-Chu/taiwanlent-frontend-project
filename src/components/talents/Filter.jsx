    ...
    return (
      <form onSubmit={e => this.submitFilters(e)}>
        <div>
          ...
          >
            ...
            <label htmlFor="" className="checkbox">
              <input
                ...
                checked={this.state.selectAllRegionsIsChecked}
                onChange={() => this.selectAllRegions()}
              />
          ...
          >
            ...
            <label htmlFor="" className="checkbox">
              <input
                type="checkbox"
                name="selectAllLangs"
                checked={this.state.selectAllLangsIsChecked}
                onChange={() => this.selectAllLangs()}
              />
              <span className="checkbox-label">全選</span>
            </label>
          </div>
          ...
          >
            ...
            <label htmlFor="" className="checkbox">
              <input
                ...
                checked={this.state.selectAllSubjectsIsChecked}
          ...
          <button
            type="submit"
            className="btn btn-default btn-success filter-button"
          >
            Filter
          </button>
        </div>
